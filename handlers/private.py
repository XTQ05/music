            ...
            [
                [
                    InlineKeyboardButton(
                        "🎉 𝐁𝐞𝐧𝐢 𝐆𝐫𝐮𝐛𝐚 𝐄𝐤𝐥𝐞 🎉", url=f"https://t.me/LuksMusicRoBot?startgroup=true"
                    )
                ],
                [
                    InlineKeyboardButton(
                        "🇹🇷 𝐀𝐬𝐢𝐬𝐭𝐚𝐧", url="https://t.me/LuksMusicAsistant"
                    ),
                    InlineKeyboardButton(
                        "📝 𝐒𝐚𝐡𝐢𝐩", url="https://t.me/ismayilzadevuqar"
                    )
                ],
                [
                    InlineKeyboardButton(
                    ...
                    InlineKeyboardButton(
                        "📝 𝐊𝐚𝐧𝐚𝐥", url=f"https://t.me/LuksProject"
                    )
                ]
...
async def admin(_, query: CallbackQuery):
    ...
    reply_markup=InlineKeyboardMarkup(
             [
                 [
                     InlineKeyboardButton(
                         "⚙ Geliştirici", url="https://t.me/ismayilzadevuqar")
                 ],
                 [
                     InlineKeyboardButton(
